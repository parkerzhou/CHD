	...
	public int doEndTag() throws JspException {
		try {
			...
			if (layout.equals("div")) {
				sb.append("<link rel=\"stylesheet\" href=\"js/plug-in/Validform/css/divfrom.css\" type=\"text/css\"/>");
				if (tabtitle != null)
					sb.append("<script type=\"text/javascript\" src=\"js/plug-in/Validform/js/form.js\"></script>");
			}
			sb.append("<link rel=\"stylesheet\" href=\"js/plug-in/Validform/css/style.css\" type=\"text/css\"/>");
			sb.append("<link rel=\"stylesheet\" href=\"js/plug-in/Validform/css/tablefrom.css\" type=\"text/css\"/>");
			sb.append("<script type=\"text/javascript\" src=\"js/plug-in/Validform/js/Validform_v5.3.1_min.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"js/plug-in/Validform/js/Validform_Datatype.js\"></script>");
			//----------------------------------------------------------------
			//update-begin--Author: Date:20130225 for：金额校验规则
			sb.append("<script type=\"text/javascript\" src=\"js/plug-in/Validform/js/datatype.js\"></script>");
			//update-end--Author: Date:20130225 for：金额校验规则
			//----------------------------------------------------------------
			if (usePlugin != null) {
				if (usePlugin.indexOf("jqtransform") >= 0) {
					sb.append("<SCRIPT type=\"text/javascript\" src=\"js/plug-in/Validform/plugin/jqtransform/jquery.jqtransform.js\"></SCRIPT>");
					sb.append("<LINK rel=\"stylesheet\" href=\"js/plug-in/Validform/plugin/jqtransform/jqtransform.css\" type=\"text/css\"></LINK>");
				}
				if (usePlugin.indexOf("password") >= 0) {
					sb.append("<SCRIPT type=\"text/javascript\" src=\"js/plug-in/Validform/plugin/passwordStrength/passwordStrength-min.js\"></SCRIPT>");
				}
			}
			sb.append("<script type=\"text/javascript\">");
			sb.append("$(function(){");
			sb.append("$(\"#" + formid + "\").Validform({");
			//update-begin--Author:gyc  Date:20130415 for：验证信息的显示方式改动
...
//			sb.append("}");
//			sb.append("},");
			//update-end--Author:gyc  Date:20130415 for：验证信息的显示方式改动
			...
			if (dialog) {
				...
				//----------------------------------------------------------------
				//update-begin--Author: Date:20130409 for：错误提示
				//----------------------------------------------------------------
				//先判断是否成功，成功再刷新父页面，否则return false    
		        
				//----------------------------------------------------------------
				//update-begin--Author: Date:20130426 for：错误提示返回提示的展示bug
				//----------------------------------------------------------------
				...
				//----------------------------------------------------------------
				//update-end--Author:gyc  Date:20130409 for：错误提示
				//----------------------------------------------------------------
			} else {
