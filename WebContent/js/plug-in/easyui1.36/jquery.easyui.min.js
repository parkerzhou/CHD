...
_932(this,q);
}},currentText:"Today",clearText:"clear",closeText:"Close",okText:"Ok",buttons:[{text:function(_945){
...
//- -- -----mark 为datebox添加清空按钮
{text:function(_11093){
	return $(_11093).datebox("options").clearText;
 },
 handler:function(_11094){
	$(_11094).combo("setValue","").combo("setText","");
