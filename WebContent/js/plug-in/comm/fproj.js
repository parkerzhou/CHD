...
function addFproj(){
	...
	$("#sign_state").combobox("setValue","0");
...
function openFprojAreaDlg(){
	openCommDialog('区域选择','franController.do?getCommPage&page=areaSel',900,500,function(){
				data={};
...
function openFprojCompanySel(){
	...
	openCommDialog('公司资料选择','franController.do?getCommPage&page=cmpSel',900,500,function(){
...
function openFprojFranSel(){
	openCommDialog('加盟方资料选择','franController.do?getCommPage&page=franSel',900,500,function(){
...
function openEmployeeDeptSel(){
	...
	openCommDialog('雇员资料选择','franController.do?getCommPage&page=empl',900,500,function(){
...
function formFproj(formtype){
	
		window.location.href = 'franController.do?GetFprojPDForEXCEL&formtype='+formtype+'&name=fprojchisee';
