	...
	$(function(){
		...
		$('#datagrid').datagrid({
			...
			onDblClickRow : function(rowIndex, row) {
				...
				//公司下拉列表框动态加载数据  
				$('#editWindow #usCompany').combobox({
					url:'ummUserInfoController.do?getCompanyComboboxData', 
				    valueField:'cmp_name',    
				    textField:'cmp_name'
				});
				//读取记录填充到表单中
		...
		//	url:'ummUserInfoController.do?getUserInfo',
			...
			columns:[[
			      ...
			      {field:'us_company',title:'公司',width : 80}
			]],
			toolbar:'#toolbar',
/*			queryParams: {
				ug_name:'所有',
