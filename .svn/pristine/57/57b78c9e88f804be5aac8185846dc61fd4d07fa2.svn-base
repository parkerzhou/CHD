...
import com.glorisun.chd.core.util.ReflectHelper;
import com.glorisun.chd.core.util.StringUtil;
import com.glorisun.chd.core.util.oConvertUtils;
import com.glorisun.chd.pojo.json.ComboBox;
import com.glorisun.chd.pojo.json.DataGrid;
import com.glorisun.chd.tag.core.gsui.pojo.Autocomplete;
import com.glorisun.chd.tag.core.gsui.pojo.DataTableReturn;
...
public class TagUtil {
	...
	private static String listtojson(String[] fields, int total, List list,String[] footers) throws Exception {
		...
		jsonTemp = jsonTemp + "]";
		//update-begin--  Date:20130520 for：TASK #109 datagrid标签没有封装合计功能
		if(footers!=null){
			jsonTemp = jsonTemp + ",";
		...
		//update-end--  Date:20130520 for：TASK #109 datagrid标签没有封装合计功能
		jsonTemp = jsonTemp + "}";
		return jsonTemp;
	}
	/**
