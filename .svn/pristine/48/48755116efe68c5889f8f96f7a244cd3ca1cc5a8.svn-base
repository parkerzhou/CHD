...
<div id = "franTb" style = "padding:5px;height:auto">
		<div id="tb" style = "margin-bottom:5px;">
			...
			<a href = "javascript:void(0)" class = "easyui-linkbutton" iconCls = "icon-print" onclick = "form(0)">报表</a>
			<a href = "javascript:void(0)" class = "easyui-linkbutton" iconCls = "icon-print" onclick = "form(1)">输出至EXCEL</a>
		</div>
</div>
<div id="franLayout" class="easyui-layout" data-options = "fit:true" style="width:900px;height:450px;">     
    <div data-options="region:'center'">
    	<table id = "franDataGrid" class = "easyui-datagrid" style = "width:400px;height:250px;"
    			data-options = "border:0,rownumbers:true,fitColumns:true,fit:true,toolbar:'#franTb',pagination:true,pageList:[10,15,20,30,50,100],singleSelect:true">
	    	<thead>
		    	<tr>
		    	 <th data-options="field:'cmp_id',width:100">加盟方代码</th>   
