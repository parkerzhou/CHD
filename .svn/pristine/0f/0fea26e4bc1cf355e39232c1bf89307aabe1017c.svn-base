...
<body>   
	...
	<!--  -->
	<!-- 新增用户信息窗口 -->
	<div id="addWindow"  title="" class="easyui-window" style="width:550px; height:400px; left:35px;top:35px" 
		...
		<div class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'center'" border="false">
				<form id="addForm" method="post" action="#">
					...
					<br />
					<div>
						<label for="usCompany">所在公司：</label>
						<input id="usCompany" name="usCompany" class="easyui-combobox" panelHeight="auto"  data-options="required:false,editable:false">
					</div>
					<br /><br />
				</form>
			</div>
	...
	<!-- 修改用户信息窗口 -->
	<div id="editWindow"  title="" class="easyui-window" style="width:550px; height:400px; left:35px; top:35px" 
	data-options="modal:true,closed:true,resizable:false,minimizable:false,maximizable:false,closable:false">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'north'" style="padding:20px 20px 0px 20px;height:80px" border="false">
				<h2>用户管理_[修改]</h2>
