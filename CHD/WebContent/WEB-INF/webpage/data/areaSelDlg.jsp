...
function openAreaSelDlg(data,method){
	...
	if(area_Type==2){
		areaDataGrid.datagrid('reload',{owner_zone:data.country,zone_type:1});
	}else if(area_Type==3){
		areaDataGrid.datagrid('reload',{owner_zone:data.province,zone_type:2});
	}else if(area_Type==4){
		areaDataGrid.datagrid('reload',{owner_zone:data.city,zone_type:3});
	}else if(area_Type==5){
		areaDataGrid.datagrid('reload',{owner_zone:data.county,zone_type:4});
	}
}
